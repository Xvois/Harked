import {getLocalData, getLocalDataByID, getUser, updateLocalData} from "../API/pocketbase";
import {FollowingRecord, FollowersRecord} from "./Interfaces/followingInterfaces";
...
export const followUser = async function (primaryUserID: string, targetUserID: string) {
    ...
    let [primaryObj, targetObj]: Array<FollowingRecord> = [await getLocalDataByID<FollowingRecord>("user_following", hashString(primaryUserID)), await getLocalDataByID<FollowingRecord>("user_following", hashString(targetUserID))];
