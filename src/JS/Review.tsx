    ...
    return (
        review && possessive &&
            <>
                ...
                <a className={'heavy-link'} style={{fontSize: '30px'}} href={`/profile/${review.owner.user_id}`}>{review.owner.username}</a>
                <div style={{position: 'relative', width: '100%', marginTop: '15px'}}>
                    <img style={{width: '100%', height: '100px', top: 0}} className={'backdrop-image'} alt={getLIName(review.item)} src={review.item.image} />
